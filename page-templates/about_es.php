  ...
  <aside class="grid col-three-quarters mq2-col-two-thirds mq3-col-full">
    ...
    <section id="skills" class="sectionAbout">
      ...
      <dl>
		...
		<dd title="ElasticSearch">ElasticSearch</dd>
	...
	<article>
        ...
        <time datetime="2021-05-01" class="start">May 2021</time>
        <time class="end">Present</time>
        <p>
			PagoNxt provee soluciones de pago a grandes corporaciones, vendedores y consumidores.
        ...
        <ul>
			...
			<li>Kafka</li>
			<li>ElasticSearch</li>
			<li>Git and Gradle</li>
        </ul>

      </article>
	<article>
        <h1>
			<a href="https://wata.es" title="watafactory" target="_blank">Wata Factory<span>&nbsp;&nbsp;&nbsp;&nbsp;(Jerez de la Frontera, Cádiz, España)</span></a>
        </h1>

        <h2>Senior Software Engineer</h2>
        <time datetime="2020-09-15" class="start">Sep. 2020</time>
        <time datetime="2021-05-01" class="end">May. 2021</time>
        <p>
			Wata Factory is una consultora especialista en outsourcing de Jerez de la Frontera. Esta compañia oferta soluciones tecnológicas a varias empresas europeas. Especialmente en Alemania.
		</p>
        <p>
			En esta compañia desarrollé una aplicación Back-End en Java 11 y realicé modificaciones en varias aplicaciones Angular para un CRM de una empresa alemana. También impartí cursos de tecnologías Big Data.
        </p>
